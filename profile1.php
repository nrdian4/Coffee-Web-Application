...
?>
   <section class=display-product-table" style="font-size:250%; background: url(../image/home4.jpeg) no-repeat; color: black;">



         <?php
            $c_username = isset($_SESSION['c_log_username']);
        ...
        <br>
            ...
            <span>
               <a href="login.php" class="btn" name="logout">LogOut </a>
            </span>
        </br>
...
if(isset($_POST['edit_customer'])){ 
   ...
   $update_query = mysqli_query($conn, "UPDATE `customer` SET CUST_NAME = '$update_c_name', CUST_USERNAME = '$update_c_username', ADDRESS = '$update_c_address', CUST_EMAIL = '$update_c_email', CUST_PHONE = '$update_c_phone' WHERE CUST_ID = '$update_c_id'");

   if($update_query){
      $message[] = 'edit succesfully';
      header('location:profile.php');
   }else{
      $message[] = 'could not be edit';
      header('location:profile.php');
   }
...
<section class=display-product-table" style="font-size:250%; background: url(../image/home4.jpeg) no-repeat; color: black;">
        ...
        <br>
            ...
            <span>
               <a href="login.php" class="btn" name="logout">Log Out </a>
            </span>
        </br>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="edit" name="edit_customer" class="btn">
