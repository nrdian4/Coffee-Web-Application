...
<section class="shopping-cart">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            <td><img src="uploaded_img/<?php echo $fetch_cart['CART_IMAGE']; ?>" height="100" alt=""></td>
            <td><?php echo $fetch_cart['PRODUCT_NAME']; ?></td>
            <td>RM<?php echo number_format($fetch_cart['CART_PRICE']); ?>/-</td>
            <td>
               <form action="" method="post">
                  ...
                  <input type="submit" value="update" class="btn" name="update_update_btn">
               </form>   
            </td>
            <td>RM<?php echo $sub_total = number_format($fetch_cart['CART_PRICE'] * $fetch_cart['CART_QUANTITY']); ?>/-</td>
            <td><a href="cart.php?remove=<?php echo $fetch_cart['CART_ID']; ?>" onclick="return confirm('remove item from cart?')" class="btn"> <i class="fas fa-trash"></i> remove</a></td>
         </tr>
         <?php
